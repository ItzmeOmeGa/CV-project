...
1. **Face Detection**: Uses OpenCV with histogram equalization to detect faces in varying lighting conditions
2. **Mood Recognition**: Utilizes DeepFace (with VGG-Face and pre-trained emotion models) to analyze facial expressions
3. **Logging**: Records detected moods with timestamps to CSV for later analysis
4. **Display**: Live feed shows detected faces with emotion labels and confidence scores
